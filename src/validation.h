 ...
 *  We have 4 times smaller block times in Ukkey, so we need to push 4 times more invs per 1MB. */
...
CAmount GetFounderPayment(int nHeight, CAmount blockValue);    // ukkeyHG
