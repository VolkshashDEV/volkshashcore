...
//! These need to be macros, as clientversion.cpp's and volkshash*-res.rc's voodoo requires it
...
/**
 * volkshashd-res.rc includes this file, but it cannot cope with real c++ code.
