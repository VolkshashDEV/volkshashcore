# Linearize
Construct a linear, no-fork, best version of the Ukkey blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install ukkey_hash

https://github.com/ukkeypay/ukkey_hash
...
JSON-RPC server. Running `ukkeyd` or `ukkey-qt -server` will be sufficient.
...
* `input`: ukkeyd blocks/ directory containing blkNNNNN.dat
