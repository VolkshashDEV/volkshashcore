# Linearize
Construct a linear, no-fork, best version of the Volkshash blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install volkshash_hash

https://github.com/volkshashpay/volkshash_hash
...
JSON-RPC server. Running `volkshashd` or `volkshash-qt -server` will be sufficient.
...
* `input`: volkshashd blocks/ directory containing blkNNNNN.dat
