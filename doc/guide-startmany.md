...
[From the ukkey github repo](https://github.com/ukkeypay/ukkey/blob/master/doc/masternode_conf.md)
...
## Update ukkey.conf on server

If you generated a new masternode private key, you will need to update the remote `ukkey.conf` files.

Shut down the daemon and then edit the file.

```nano .ukkeycore/ukkey.conf```

### Edit the masternodeprivkey
If you generated a new masternode private key, you will need to update the `masternodeprivkey` value in your remote `ukkey.conf` file.
...
and comparing with the official explorer at https://explorer.ukkey.org/chain/Ukkey
...
Search your Masternodes on https://ukkeyninja.pl/masternodes.html
