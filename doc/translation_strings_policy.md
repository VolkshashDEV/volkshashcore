...
This document provides guidelines for internationalization of the Ukkey Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `ukkey_en.ts` remains unchanged.
