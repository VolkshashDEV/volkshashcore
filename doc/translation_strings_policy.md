...
This document provides guidelines for internationalization of the Volkshash Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `volkshash_en.ts` remains unchanged.
